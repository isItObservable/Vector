...
## Episode : Vector
<p align="center"><img src="/image/vector.png" width="40%" alt="Vector" /></p>
This repository contains the files utilized during the tutorial presented in the dedicated IsItObservable episode explaining what is new in Vector.
...
### 4.Clone Github repo
```shell
git clone https://github.com/isitobservable/Vector
cd Vector
```
...
```
### Deploy the Vector dashboard in Dynatrace.

in Dynatrace , type ctrl + K and search the Dashboard application.
Once the dasboard application openened
<p align="center"><img src="/image/add_dahsboard.png" width="40%" alt="Uploade" /></p>
Click upload, and upload the following file: dynatrace/Vector.json
<p align="center"><img src="/image/vector_dashboard.png" width="40%" alt="dashboard" /></p>
